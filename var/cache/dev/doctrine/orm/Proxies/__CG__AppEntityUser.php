...
class User extends \App\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\User' . "\0" . 'id', '' . "\0" . 'App\\Entity\\User' . "\0" . 'email', '' . "\0" . 'App\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'App\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'App\\Entity\\User' . "\0" . 'password', '' . "\0" . 'App\\Entity\\User' . "\0" . 'customer', '' . "\0" . 'App\\Entity\\User' . "\0" . 'client', '' . "\0" . 'App\\Entity\\User' . "\0" . 'manager', '' . "\0" . 'App\\Entity\\User' . "\0" . 'isVerified'];
        }
     ...
     * {@inheritDoc}
     */
    public function setCustomer(\App\Entity\Customer $customer): \App\Entity\User
    {
     ...
     * {@inheritDoc}
     */
    public function setManager(\App\Entity\Manager $manager): \App\Entity\User
    {
